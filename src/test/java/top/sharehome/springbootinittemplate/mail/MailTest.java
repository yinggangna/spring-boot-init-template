...
public class MailTest {
    ...
    public void testSendSimpleText() throws InterruptedException {
        ...
        EmailUtils.sendSimpleText(to, subject, text);
    ...
    public void testSendWithHtml() throws InterruptedException {
        ...
        EmailUtils.sendWithHtml(to, subject, text);
        ThreadUtils.sleep(Duration.ofSeconds(10));
    }
    ...
    public void testSendWithImageHtmlByClient() throws InterruptedException, IOException {
        ...
        EmailUtils.sendWithImageHtmlByClient(to, subject, htmlContent, cids, files);
        ThreadUtils.sleep(Duration.ofSeconds(10));
    }
    ...
    public void testSendWithImageHtmlByServer() throws InterruptedException {
        ...
        EmailUtils.sendWithImageHtmlByServer(to, subject, htmlContent, cids, filePaths);
        ThreadUtils.sleep(Duration.ofSeconds(10));
    }
    ...
    public void testSendWithAttachmentByClient() throws InterruptedException, IOException {
        ...
        EmailUtils.sendWithAttachmentByClient(to, subject, htmlContent, files, true);
        EmailUtils.sendWithAttachmentByClient(to, subject, htmlContent, files, false);
        ThreadUtils.sleep(Duration.ofSeconds(10));
    }
    ...
    public void testSendWithAttachmentByServer() throws InterruptedException {
        ...
        EmailUtils.sendWithAttachmentByServer(to, subject, htmlContent, filePaths, true);
        EmailUtils.sendWithAttachmentByServer(to, subject, htmlContent, filePaths, false);
        ThreadUtils.sleep(Duration.ofSeconds(10));
    }
